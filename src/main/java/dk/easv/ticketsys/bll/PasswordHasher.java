...
public class PasswordHasher {
    ...
    public static String hashPassword(String password, String stringForSalt) throws NoSuchAlgorithmException, InvalidKeySpecException {
    ...
    public static byte[] generateSalt(String notSalted) {
